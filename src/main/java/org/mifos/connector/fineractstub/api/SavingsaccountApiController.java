...
public class SavingsaccountApiController implements SavingsaccountApi {
    ...
    public ResponseEntity<Void> transfers(@Parameter(in = ParameterIn.DEFAULT, description = "post savings Account transfers", schema=@Schema()) @Valid @RequestBody InteropTransfers body) {
        String accept = request.getHeader("Accept");
