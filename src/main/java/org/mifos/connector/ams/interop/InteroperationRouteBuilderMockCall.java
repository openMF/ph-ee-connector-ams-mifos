...
public class InteroperationRouteBuilderMockCall extends ErrorHandlerRouteBuilder {
    ...
    @Autowired
    private PrepareLocalQuoteRequestMockCall prepareLocalQuoteRequest;

    @Autowired
    private QuoteResponseProcessorMockCall quoteResponseProcessor;

    @Autowired
    private PrepareTransferRequestMockCall prepareTransferRequest;

    @Autowired
    private TransfersResponseProcessorMockCall transfersResponseProcessor;

    @Autowired
    private ClientResponseProcessorMockCall clientResponseProcessor;

    @Autowired
    private InteropPartyResponseProcessorMockCall interopPartyResponseProcessor;
    ...
    public InteroperationRouteBuilderMockCall() {
        super.configure();
    }
