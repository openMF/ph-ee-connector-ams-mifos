...
public class PrepareLocalQuoteRequest implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        FspMoneyData amount = new FspMoneyData(channelRequest.getAmount().getAmountDecimal(), channelRequest.getAmount().getCurrency());
        QuoteFspRequestDTO request = new QuoteFspRequestDTO(exchange.getProperty(TRANSACTION_ID, String.class), requestCode, quoteId,
                ...
                TransactionRole.valueOf(exchange.getProperty(TRANSACTION_ROLE, String.class)), channelRequest.getTransactionType());
