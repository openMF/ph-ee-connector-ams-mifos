...
import org.mifos.connector.ams.defination.AccountStatus;
...
@RestController
public class AccountStatusController implements AccountStatus {
    ...
    @Override
    public StatusResponseDTO accountStatus(String IdentifierType, String IdentifierId, String tenantId) throws JsonProcessingException {
        ...
        Exchange exchange = SpringWrapperUtil.getDefaultWrappedExchange(producerTemplate.getCamelContext(),
                headers, null);
        producerTemplate.send("direct:get-account-status", exchange);

        String body = exchange.getIn().getBody(String.class);
        return objectMapper.readValue(body, StatusResponseDTO.class);
    }
}
